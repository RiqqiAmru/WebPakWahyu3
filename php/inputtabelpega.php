...
$barang = query("SELECT * FROM pegawai");
...
<body>
  ...
  <main>
    ...
    <body style="margin-top: 50px; background-color: #fdffe0;">
      <br>
      <h1 style="text-align: center;" class="q">TABEL Pegawai</h1>
        ...
        <div class="row ">
            ...
            <form action="saveee.php" method="POST">
              <table class="table table-striped table-danger table-hover border border-danger" style="width: 450px; margin-left: auto; margin-right: auto; margin-top: auto;">
                <thead class="thead-danger">
                  <th class="q" colspan="3" style="text-align: center;">Form Pegawai</th>
                ...
                <tbody>
                  <tr class="q">
                    <td>Kode Pegawai</td>
                    <td>:</td>
                    <td><input type="text" name="kdpg"></td>
                  </tr>
                  <tr class="q">
                    <td>Nama Pegawai</td>
                    <td>:</td>
                    <td><input type="text" name="nmpg"></td>
                  </tr>
                  <tr class="q">
                    <td>Alamat Pegawai</td>
                    <td>:</td>
                    <td><input type="text" name="alpg"></td>
                  </tr>
                  <tr class="q">
                    <td>Kota Pegawai</td>
                    <td>:</td>
                    <td><input type="text" name="ktpg"></td>
                  </tr>
                  <tr>
                    <td colspan="2"><input type="reset" value="HAPUS"></td>
                    <td align="right"><input type="submit" value="KIRIM / SIMPAN" name="t4" id="t4"></td>
                  </tr>
                </tbody>
              </table>
            </form>
          ...
          <div class="col ">
            ...
            <table class="table table-striped table-danger table-hover border border-danger" style="width: auto; margin-left: auto; margin-right: auto; margin-top: auto;" border="1">
              <thead class="thead-danger">
                <th class="q" colspan="9" style="text-align: center;">Data Pegawai</th>
