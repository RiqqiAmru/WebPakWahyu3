...
$barang = query("SELECT * FROM customer");
...
<body>
  ...
  <main>
    ...
    <body style="margin-top: 50px; background-color: #fdffe0;">
      <br>
      <h1 style="text-align: center;" class="q">TABEL CUSTOMER</h1>
        ...
        <div class="row ">
            ...
            <form action="saveee.php" method="POST">
              <table class="table table-striped table-danger table-hover border border-danger" style="width: 450px; margin-left: auto; margin-right: auto; margin-top: auto;">
                <thead class="thead-danger">
                  <th class="q" colspan="3" style="text-align: center;">Form Customer</th>
                ...
                <tbody>
                  <tr class="q">
                    <td>Kode Customer</td>
                    <td>:</td>
                    <td><input type="text" name="Kode--Customer" size="10"></td>
                  </tr>
                  <tr class="q">
                    <td>Nama Customer</td>
                    <td>:</td>
                    <td><input type="text" name="Nama--Customer" size="10"></td>
                  </tr>
                  <tr class="q">
                    <td>Alamat Customer</td>
                    <td>:</td>
                    <td><input type="text" name="Alamat--Customer" size="10"></td>
                  </tr>
                  <tr>
                    <td colspan="2"><input type="reset" value="HAPUS"></td>
                    <td align="right"><input type="submit" value="KIRIM / SIMPAN" name="t3" id="t3"></td>
                  </tr>
                </tbody>
              </table>
            </form>
          ...
          <div class="col ">
            ...
            <table class="table table-striped table-danger table-hover border border-danger" style="width: auto; margin-left: auto; margin-right: auto; margin-top: auto;" border="1">
              <thead class="thead-danger">
                <th class="q" colspan="9" style="text-align: center;">Data Customer</th>
